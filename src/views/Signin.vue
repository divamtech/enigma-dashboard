              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form role="form" @submit="handleSubmit">
                    <div class="mb-3">
                      <argon-input v-model="formData.email.value" id="email" type="email" placeholder="Email" name="email"
                        size="lg" />
                    </div>
                    <div class="mb-3">
                      <argon-input v-model="formData.password.value" id="password" type="password" placeholder="Password"
                    ...
                    <div class="text-center">
                      <argon-button type="submit" class="mt-4" variant="gradient" color="success" fullWidth size="lg">Sign
                        in</argon-button>
                    </div>
                  </form>
                </div>
...
const handleSubmit = async (event) => {
  ...
  try {
    ...
    // e.g., show a success message or redirect to another page
  } catch (error) {
